...
export const AnimatedThemeToggler = ({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        'h-7 w-7 rounded-md bg-surface-card/60 hover:bg-surface-card text-muted-foreground hover:text-foreground flex items-center justify-center transition-all card-shadow active:scale-95 cursor-pointer select-none',
        className
      )}
    ...
    >
      {isDark ? (
        ...
        <Moon className="h-3.5 w-3.5 text-cyan-400 transition-transform duration-200 hover:-rotate-12" />
      )}
